...
from appconfig.Config import getBrokerAppConfig, getServerConfig, getSystemConfig
...
app.add_url_rule("/apis/broker/login/<broker_name>", view_func=BrokerLoginAPI.as_view("broker_login_api"), methods=['GET', 'POST'])
